...
public class DBHelper extends SQLiteAssetHelper {
    ...
    public void setCard(String category, String card_type, String number, String name, String expiry, String cvv , String bankName) {
        ...
        try {
            ...
            AesCbcWithIntegrity.CipherTextIvMac cipherBankName = AesCbcWithIntegrity.encrypt(bankName , keys);
            ...
            contentValues.put("bank_name", cipherBankName.toString());
        } catch (GeneralSecurityException e) {
            e.printStackTrace();
